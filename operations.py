...
books = {
    ...
    "B002": {"title": "Data Science 101", "author": "Jane SAM", "genre": "Non-Fiction", "total_copies": 2},
    "B003": {"title": "Web Development", "author": "Ali Bowen", "genre": "Non-Fiction", "total_copies": 4},
}

# Members list
members = [
    {"member_id": "S001", "name": "lizzy", "email": "lizzy@example.com", "borrowed_books": []},
    {"member_id": "S002", "name": "Lexcorp", "email": "lexcorpn@example.com", "borrowed_books": []},
    {"member_id": "S003", "name": "mamad", "email": "mamad@example.com", "borrowed_books": []},
    {"member_id": "ST001", "name": "Arthakusie", "email": "kusie@library.com", "borrowed_books": []},
    {"member_id": "ST002", "name": "Josiah", "email": "Josiah@library.com", "borrowed_books": []},
]
...
users = {
    # admins
    "Abriel": {"password": "207", "role": "admin"},
    "Elijah": {"password": "206", "role": "admin"},
    # staff (linked to member IDs)
    "Arthakusie": {"password": "kusie01", "role": "staff", "member_id": "ST001"},
    "Josiah": {"password": "siah02", "role": "staff", "member_id": "ST002"},
    # students (linked)
    "lizzy": {"password": "liz", "role": "student", "member_id": "S001"},
    "lexcorp": {"password": "lex", "role": "student", "member_id": "S002"},
    "mamad": {"password": "mado", "role": "student", "member_id": "S003"},
}
